...
Now that the necessary elementary matching functions are defined, it is easy to define matching functions for two primitive shapes based on the elementary matching functions. 
