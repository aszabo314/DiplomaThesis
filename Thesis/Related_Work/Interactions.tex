...
Interacting with point clouds is a fundamental task. Removing unwanted points from the data set, selecting regions of interest, or creating new geometry are examples on interactions that can be performed on point clouds. 
\\
